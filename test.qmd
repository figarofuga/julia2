...
km_dat = DataFrame(times = ourtime, survival_rate = survival_rate)
...
f = Figure()
ax1 = Axis(f[1, 1], title="Kaplan-Meier Curve", xlabel="Time", ylabel="Survival Rate", limits = (0, 5500, 0.85, 1))
